...
import ForbiddenCss from "../ForbiddenCss.css"

function Forbidden() {
    // return (
    //   <div style={{height:"100vh",width:"100%",backgroundColor:"#233142"}}>
    //     <meta charSet="UTF-8" />
    ...
    //       </svg>
    //     </use>
    //     {/* <img src="/imposter.jpg" style={{height:"250px"}} className="whistle"></img> */}
    //     <h1>403</h1>
